...
df = pd.read_csv(os.path.join(os.path.dirname(__file__), '/Users/student/Desktop/Data_Exploration_Project/1_Datenset/ursprüngliche/disney_plus_titles.csv'), sep=',')
